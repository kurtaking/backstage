...
export const CatalogIncrementalIngestionPage =
  catalogIncrementalIngestionPlugin.provide(
    createRoutableExtension({
      name: 'CatalogIncrementalIngestionPage',
      component: () =>
        import('./components/IncrementalIngestion').then(
          m => m.IncrementalIngestion,
        ),
